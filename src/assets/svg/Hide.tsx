...
function Hide({ stroke, ...props }: ISVGProps) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <path
        d="M19.4476 8.9908C20.1356 9.9048 20.7406 10.9598 21.2496 12.1368C19.2826 16.6938 15.8066 19.4388 11.9996 19.4388C11.1366 19.4388 10.2856 19.2988 9.46759 19.0258"
        stroke="#4F4F4F"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
