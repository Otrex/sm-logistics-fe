...
const MoreAbout = () => (
  ...
  <Width75p className="pt-44">
    <div className="flex flex-row">
      <div className="w-4/8">
        <H148>
          Best Drivers.<br /> Effective Tracking. Super-Fast Deliveries.
        </H148>
      </div>
      <div className="w-5/8 pl-12">
        <P16>
          ...
          upi can be sure of Super-Fast Delivery with Optimal Quality,
        ...
        <div className="flex flex-row">
          <div className="w-1/2">
            <div className="flex flex-row items-center">
              <Check stroke="#FAB60B"/>
              <P16 bold className="ml-6">Express Delivery</P16>
            </div>
            <div className="flex flex-row items-center">
              <Check stroke="#FAB60B" />
              <P16 bold className="ml-6">Real-Time Tracking</P16>
            </div>
          </div>
          <div className="w-1/2">
            <div className="flex flex-row items-center">
              <Check stroke="#FAB60B" />
              <P16 bold className="ml-6">Scheduled Pickups</P16>
            </div>
            <div className="flex flex-row items-center">
              <Check stroke="#FAB60B" />
              <P16 bold className="ml-6">Available on Web & Mobile</P16>
            </div>
          </div>
        </div>
      </div>
...
const OurPeople = () => <>
  <Width75p className="pt-44 pb-20">
    <div className="text-center">
      ...
      <P16 className="px-80">
      We cherish our people and love every moment we share together.
      </P16>
    </div>
  </Width75p>
